...
@Configuration
@MapperScan(basePackages = "com.mycompany.webapp.dao.orderdb", sqlSessionFactoryRef = "db3SqlSessionFactory")
public class OrderDbConfig {
	...
	public static final String DB3_DATASOURCE = "db3DataSource";
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier(DB3_DATASOURCE) DataSource dataSource) throws Exception {
