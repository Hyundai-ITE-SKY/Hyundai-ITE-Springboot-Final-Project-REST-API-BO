...
@Configuration
@MapperScan(basePackages = "com.mycompany.webapp.dao.memberdb", sqlSessionFactoryRef = "db2SqlSessionFactory")
public class MemberDbConfig {
	...
	public static final String DB2_DATASOURCE = "db2DataSource";
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier(DB2_DATASOURCE) DataSource dataSource) throws Exception {
