...
@Configuration
@MapperScan(basePackages = "com.mycompany.webapp.dao.productdb", sqlSessionFactoryRef = "db1SqlSessionFactory")
public class ProductDbConfig {
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier(DB1_DATASOURCE) DataSource dataSource) throws Exception {
