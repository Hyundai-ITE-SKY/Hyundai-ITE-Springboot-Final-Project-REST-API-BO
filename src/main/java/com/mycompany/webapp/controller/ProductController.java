...
public class ProductController {
	...
	public Map<String, Object> getSearchList(@RequestParam("type") String type, @RequestParam("w") String keyword,
	...
	public Map<String, Object> getSearchStockList(@RequestParam("type") String type, @RequestParam("w") String keyword,
